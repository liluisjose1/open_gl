...
void display()
{
    ...
    glLoadIdentity();
    /* transformación vista en 3 lados */

		gluLookAt( 0.0, 0.0, 0.0, // punt de vista en este caso es la vista en planta 
					3.0, 2.0, -3.0, // centro del objeto es el origen
					-5.0, 0.10, 5.0); // Especifica la dirección del vector ascendente.
