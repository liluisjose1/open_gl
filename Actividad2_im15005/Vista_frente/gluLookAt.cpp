...
void display()
{
    ...
    glLoadIdentity();
    /* transformación vista de frente */

		gluLookAt( 0.0, 0.0, -1.0, // punt de vista en este caso es la vista en planta 
					0.0, 0.0, 0.0, // centro del objeto es el origen
					-1.0, 0.0, -1.0); // Especifica la dirección del vector ascendente.
